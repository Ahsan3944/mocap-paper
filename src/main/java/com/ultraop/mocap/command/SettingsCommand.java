...
public final class SettingsCommand {
    private static final List<String> NAMES = List.of(
            ...
            "track_entities", "entity_tracking_distance", "play_entities", "prevent_tracking_played_entities", "on_death", "on_change_dimension",
