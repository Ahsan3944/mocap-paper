...
public final class PlaybackManager {
    ...
    public PlaybackSession play(UUID recordingId, Player viewer) {
        RecordingSession r = recordingManager.get(recordingId);
        return r == null ? null : play(r, viewer);
    }

    public PlaybackSession playSaved(String name, Player viewer) {
        RecordingSession r = recordingManager.getSaved(name);
        return r == null ? null : play(r, viewer);
    }

    public PlaybackSession play(RecordingSession recording, Player viewer) {
        return play(recording, viewer, getModifiers(viewer));
    }
    ...
    public PlaybackSession stop(UUID id) {
        PlaybackSession s = active.remove(id);
        if (s != null) s.stop();
        return s;
    }
