...
public record PlaybackModifiers(
    ...
    public record TransformationConfig(
        ...
        public static final TransformationConfig DEFAULT = new TransformationConfig(false, RecordingCenter.AUTO, SceneCenterType.COMMON_FIRST, null, 0.0, 0.0, 0.0);
    ...
    public static final PlaybackModifiers DEFAULT = new PlaybackModifiers(null, PlayerSkin.DEFAULT, PlayerAsEntity.DISABLED, EntityFilter.disabled(), 0.0, 0.0, 0.0, true, false, 0.0, Mirror.NONE, 1.0, 1.0, 0.0, 0.0, 0.0, TransformationConfig.DEFAULT);

    public PlaybackModifiers {
        playerSkin = playerSkin == null ? PlayerSkin.DEFAULT : playerSkin;
        playerAsEntity = playerAsEntity == null ? PlayerAsEntity.DISABLED : playerAsEntity;
        entityFilter = entityFilter == null ? EntityFilter.disabled() : entityFilter;
        mirror = mirror == null ? Mirror.NONE : mirror;
        transformationConfig = transformationConfig == null ? TransformationConfig.DEFAULT : transformationConfig;
    }
    ...
    public PlaybackModifiers withPlayerSkin(PlayerSkin value) { return copy(playerName, value, playerAsEntity, entityFilter, startDelaySeconds, waitOnStartSeconds, waitOnEndSeconds, waitForParentEnd, loop, rotationDegrees, mirror, playerScale, sceneScale, offsetX, offsetY, offsetZ, transformationConfig); }
    public PlaybackModifiers withPlayerAsEntity(PlayerAsEntity value) { return copy(playerName, playerSkin, value, entityFilter, startDelaySeconds, waitOnStartSeconds, waitOnEndSeconds, waitForParentEnd, loop, rotationDegrees, mirror, playerScale, sceneScale, offsetX, offsetY, offsetZ, transformationConfig); }
    public PlaybackModifiers withEntityFilter(EntityFilter value) { return copy(playerName, playerSkin, playerAsEntity, value, startDelaySeconds, waitOnStartSeconds, waitOnEndSeconds, waitForParentEnd, loop, rotationDegrees, mirror, playerScale, sceneScale, offsetX, offsetY, offsetZ, transformationConfig); }
    ...
    public PlaybackModifiers mergeWithParent(PlaybackModifiers parent) {
        ...
        return new PlaybackModifiers(
                ...
                playerAsEntity.enabled() ? playerAsEntity : parent.playerAsEntity,
                entityFilter.enabled() ? entityFilter : parent.entityFilter,
    ...
    private static PlaybackModifiers copy(String playerName, PlayerSkin playerSkin, PlayerAsEntity playerAsEntity, EntityFilter entityFilter,
                                           ...
                                           TransformationConfig transformationConfig) {
        return new PlaybackModifiers(playerName, playerSkin, playerAsEntity, entityFilter, startDelaySeconds, waitOnStartSeconds, waitOnEndSeconds,
                waitForParentEnd, loop, rotationDegrees, mirror, playerScale, sceneScale, offsetX, offsetY, offsetZ, transformationConfig);
    }
}
