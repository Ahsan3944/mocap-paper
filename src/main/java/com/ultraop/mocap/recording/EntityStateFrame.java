...
public record EntityStateFrame(
        ...
        ItemStack[] armor, UUID vehicleId, boolean hurt
) {
    ...
    public static EntityStateFrame capture(Entity entity, long tick, boolean hurt) {
