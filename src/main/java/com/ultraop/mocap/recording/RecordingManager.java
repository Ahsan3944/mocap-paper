...
public final class RecordingManager {
    ...
    public RecordingSession startRecording(Player p){RecordingSession s=new RecordingSession(p);active.put(s.getId(),s);return s;} public RecordingSession startRecording(Player p,String name){RecordingSession s=startRecording(p);s.setInstantSaveName(name);return s;}
